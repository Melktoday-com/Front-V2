...
import { ChevronRight, Mail, MapPin, Settings2, Verified } from "lucide-react";
        ...
        <div className="flex flex-col min-h-screen pb-24 lg:pb-12 bg-white">
            ...
            <section className="px-6 mb-8">
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-white border border-soft-border rounded-3xl p-4 flex flex-col items-center justify-center text-center">
                        <span className="text-brand font-black text-lg">۱۲</span>
                        <span className="text-secondary text-[10px] lg:text-xs font-bold whitespace-nowrap">فروخته شده</span>
                    </div>
                    <div className="bg-white border border-soft-border rounded-3xl p-4 flex flex-col items-center justify-center text-center">
